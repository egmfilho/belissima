  ...
  .provider('ProviderPessoa', ['URLS', function(urls) {
    ...
    this.$get = ['$resource', function($resource) {
      ...
      return {
        ...
        obterPessoasPorNome: function(categoriaId, nome, contato, contatoPrincipal, endereco, cep, bairro, cidade, enderecoPrincipal, categoria, limite) {
          return provider.query({
            action: 'getList'
          }, {
            person_category_id: categoriaId,
        ...
        obterPessoasPorCategoria: function(categoriaId, contato, contatoPrincipal, endereco, cep, bairro, cidade, enderecoPrincipal, categoria, limite) {
          return provider.query({
            action: 'getList'
          }, {
            person_category_id: categoriaId,
